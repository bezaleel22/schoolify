                ...
                <div class="navbar01">
                    <div class="logo">
                        <a href="{{ route('website.home') }}">
                            <img src="{{ asset('images/logo2.png') }}" alt="Lighthouse Academy" />
                        </a>
                    </div>
                    <nav class="mainMenu">
                        <ul>
                    ...
                    <div class="navleft">
                        <div class="icon_box_04">
                            <div class="ib_box">
                                <svg xmlns="http://www.w3.org/2000/svg" style="height:48px;width: 48px;" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="searchBtn">
                            ...
                            <div class="header01SearchBar">
                                <form class="d-flex" method="get" action="{{ route('website.search') }}">
