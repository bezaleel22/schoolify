                        ...
                        <div class="white-box">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex radio-btn-flex">
                                        <div class="mr-20">
                                            <input type="hidden" name="attendance[{{ @$student_record->id }}]" value="{{ @$student_record->id }}">
                                            <input type="hidden" name="attendance[{{ @$student_record->id }}][student]" value="{{ @$student_record->student_id }}">
                                            <input type="hidden" name="attendance[{{ @$student_record->id }}][class]" value="{{ @$student_record->class_id }}">
                                            <input type="hidden" name="attendance[{{ @$student_record->id }}][section]" value="{{ @$student_record->section_id }}">
                                            <input type="radio" name="attendance[{{ @$student_record->id }}][attendance_type]" id="attendanceP{{ @$student_record->id }}" value="P" class="common-radio attd">
                                            <label for="attendanceP{{ $student_record->id }}">@lang('student.present')</label>
                                        </div>
                                        <div class="mr-20">
                                            <input type="radio" name="attendance[{{ @$student_record->id }}][attendance_type]" id="attendanceL{{ @$student_record->id }}" value="A" class="common-radio">
