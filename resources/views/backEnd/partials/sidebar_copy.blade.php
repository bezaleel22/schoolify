...
<nav id="sidebar" class="sidebar">
    ...
    <ul class="sidebar_menu list-unstyled" id="sidebar_menu">
        ...
        <li data-position="{{ menuPosition(108) }}" class="sortable_li">
            ...
            <ul class="list-unstyled" id="subMenuFeesCollection">
                ...
                <a href="#subMenuFeesReport" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    @lang('lang.report')
                </a>
    ...
    <li data-position="{{ menuPosition(700) }}">
        ...
        <ul class="list-unstyled {{ spn_nav_item_open($subMenuAccount, 'show') }}" id="subMenuAccountReport">
    ...
    <li>
        ...
        <ul class="list-unstyled {{ spn_nav_item_open($subMenuExam, 'show') }}" id="examSettings">
